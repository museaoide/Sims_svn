#' Create regression rhs matrix with lags
#' 
...
#' 
#' @param xts The series we will be using.  An \code{mts} object.
#' @param lags Either a list of integer vectors giving the lags of each variable to appear in the output,
