function [G1,C,impact,fmat,fwt,ywt,gev,eu]=gensys_o(g0,g1,c,psi,pi,div)
...
% Problem with running Gensys in Octave detected by Michael Plante
% (Indiana University) 7/4/06.  
%
% In Matlab:
% [aa bb q z v w] = qz(a,b) s.t. qaz = aa, qbz = bb
%
% In Octave:
% [aa bb q z v w] = qz(a,b) s.t. q'az = aa, q'bz=bb
%
% The following line of code fixes the problem in Octave ONLY.
% The file has been renamed gensys_o.m to highlight this fact.
